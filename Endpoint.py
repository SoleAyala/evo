...
# Esta clase carga la etapa donde el Algoritmo Genético utiliza como entrada principal los datos del usuario actual. Además, se lleva a cabo el
...
class ProcessData(tornado.web.RequestHandler):
    ...
    def post(self):
        ...
        # Este objeto recupera los datos de usuario más similares a los datos del usuario actual por vecino más cercano
...
# Esta clase carga la etapa donde se presentan al usuario las recomendaciones construidas por el Algoritmo Genético. Además,
# obtenemos su retroalimentación sobre las recomendaciones.
...
# Esta clase carga la última etapa del flujo de trabajo si el usuario dice "No" o redirige al usuario a una etapa adicional
...
# Esta clase carga una etapa extra donde preguntamos sobre 4 aspectos de las recomendaciones: diversidad, nivel de sorpresa,
# confiabilidad y salubridad.
